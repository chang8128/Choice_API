...
cursor = db.cursor()
sql1 = """select CODES from t_kbg_ma_stock_20171202"""
...
data = c.csd(codes, "preclose,open,high,low,close", "2015-12-01", "2017-11-30", "RowIndex=1,period=1,adjustflag=3,curtype=1,pricetype=1,year=2017,Ispandas=1") 
...
pd.io.sql.to_sql(data,'t_csd_kbg_ma_20171202', connect_fmtc, schema='fmtcdb', if_exists='append')  

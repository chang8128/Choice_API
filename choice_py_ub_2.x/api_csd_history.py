...
cursor = db.cursor()
sql1 = """select CODES from t_sector_20121231"""
...
data = c.csd(codes, "open,close,high,low,preclose,AVERAGE,CHANGE,PCTCHANGE,VOLUME,HIGHLIMIT,AMOUNT,TURN,TRADESTATUS,LOWLIMIT,AMPLITUDE,TNUM,TAFACTOR,FRONTTAFACTOR,ISSTSTOCK,ISXSTSTOCK", "2011-10-01", "2011-10-31", "RowIndex=1,period=1,adjustflag=1,curtype=1,pricetype=1,year=2011,Ispandas=1") 
